...
import { createTodo, deleteTodo, fetchCompletedTask, getAllTodo, getStats, pendingTask, updateTodo } from "../controllers/todos.controller.js";
...
todoRouter.get("/stats", authMiddleware, getStats);
